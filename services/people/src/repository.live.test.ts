 ...
 *   - runtime grants map = 46 distinct tables incl. the five People tables (ARWD);
...
d("people live proofs (runtime role)", () => {
  it(
    "runtime grants map = 46 distinct tables (41 + five Stage 2.16 People tables) with all five People tables ARWD",
    { timeout: 30_000 },
    async () => {
