...
| 5 | Rights & Consent | `services/rights` ✅ | Rights owners, grants, status events (aggregate 12); fail-closed evaluation seam (Stage 2.21: model + CRUD + evaluation IMPLEMENTED, ports UNWIRED — gate/publishing cutover is a future authorized stage; D2.21-2). |
...
| Rights/Consent | Domain module | `services/rights` ✅ | Stage 2.21 (foundation: owners/grants/status-events + unwired evaluation seam; D2.21-2) |
