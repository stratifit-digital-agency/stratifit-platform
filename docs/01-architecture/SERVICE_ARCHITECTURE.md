...
| 5 | Rights & Consent | `services/rights` (future) | Rights owners, grants, status events (aggregate 12); fail-closed evaluation consumed by the gate and publishing. |
...
| Rights/Consent | Domain module | `services/rights` (future) | Stage 1 |
